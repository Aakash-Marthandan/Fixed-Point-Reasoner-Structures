...
while true; do
  ...
  echo "$mark" | grep -qiE "NAN|AMPUTATE|FAILED|ABORT|N-BAD|SKIPPED|INCOMPLETE|NO-PORT|NO-GRID|DEADLOCK|EXHAUSTED|ORPHANS|NO-RESUME-STATE|VALSET-MISSING|VAL-N-BAD|XROW-FAILED|XROW-N-BAD|NO-GRIDS|ROW-N-BAD|TEST-FAILED|TEST-N-BAD|NO-GRID|VALBEST-MISMATCH" && echo "  ALERT chain marker: $mark"
