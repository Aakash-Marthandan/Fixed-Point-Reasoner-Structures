# The frontier comparison, organized by parameters and by inference compute (2026-09-09; the full-set D64 rows and the k = 128 rows on every arm added 2026-09-10)
...
|---|---|---|---|---|---|
| 789,125 | **DEC-w192 (C5, ours, one seed)** | 1k × position aug | single pass D64, FULL 422,786 (99.10 on the 100k) | **99.16** | 1.31 TMAC = 2.6 TFLOPs (M); D16 95.91 at 0.33 TMAC; D128 99.42 at 2.61; D256 99.60 at 5.22 |
...
| 1.31 | 2.6 | **DEC-w192 C5, D64** | 0.79M | FULL (100k: 99.10) | **99.16** |
...
| 578 | DEC-w384 triple, k = 128 at D64 | 2.78M | 5k | 99.48–99.78 residual = verified (C0 99.76, C1 99.48, C2 99.78) | residual / verifier |
